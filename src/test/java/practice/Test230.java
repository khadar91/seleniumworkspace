...
//refer "https://deviceatlas.com/blog/list-of-user-agent-strings" for different useragents
	@Test
	...
	Command cmd2=new Command("Emulation.setDeviceMetricsOverride",
			ImmutableMap.of("width", 375, "height", 812, "deviceScaleFactor", 3,  "mobile", true ,"scale",1));
