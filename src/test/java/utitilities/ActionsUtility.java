...
public class ActionsUtility {
	...
	public void fillOnElement(WebElement e,String data)
	{
	...
	public void clickOnElementLocation(WebElement e,int xoffset,int yoffset)
	{
		wait.until(ExpectedConditions.elementToBeClickable(e));
		act.moveToElement(e).pause(Duration.ofSeconds(20)).moveByOffset(xoffset, yoffset).pause(Duration.ofSeconds(20)).click().build().perform();
	}
